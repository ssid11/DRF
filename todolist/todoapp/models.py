...
class ToDo(models.Model):
    ...
    project = models.ForeignKey(Project, on_delete=models.CASCADE, verbose_name='Название проекта',unique=False)
    author = models.ForeignKey(User,verbose_name='Автор заметки',on_delete=models.PROTECT, unique=False)
